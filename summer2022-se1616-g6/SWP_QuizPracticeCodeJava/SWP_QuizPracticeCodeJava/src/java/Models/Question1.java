...
public class Question1 {
    ...
    public Question1(int questionId, int subjectId, String questionContent, int dimensionId, int lessonId, boolean status, String image, String audio, String video, String explanation) {
