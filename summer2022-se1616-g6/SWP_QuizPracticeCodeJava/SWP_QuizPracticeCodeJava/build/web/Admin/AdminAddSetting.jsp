<%-- 
    ...
    Created on : Jun 28, 2022, 11:46:00 AM
    Author     : Halinh
--%>
                                        ...
                                        <div class="dashboard_wrap">
                                            ...
                                            <div class="row">
                                                <div class="col-xl-12 col-lg-12 col-md-12 mb-4">
                                                    <h6 class="m-0">Setting Details</h6>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row justify-content-center">
                                                <div class="col-xl-12 col-lg-12 col-md-12">
                                                    ...
                                                    <div class="form-group smalls">
                                                        <label>Reference to quiz *</label>
                                                        <select name="quizName" class="form-control">
                                                    ...
                                                    <div class="form-group smalls">
                                                        ...
                                                        <select name="type" class="form-control">
                                                            <c:forEach items="${settingType}" var="st">
                                                                <option value="${st.typeid}" ${roleValue == role.getRoleId() ? "selected" : ""}>${st.typeName}</option>
                                                            </c:forEach>    
                                                        </select>
                                                    </div>
                                                    <div class="form-group smalls">
                                                        <label>Set quiz duration *</label>
                                                        <input type="number" class="form-control" name="duration" required id="duration"/>
                                                    </div>
                                                    <div class="form-group smalls">
                                                        <label>Set quiz number of question *</label>
                                                        <input type="number" class="form-control" name="numberQuest" required id="numberQuest"/>
                                                    </div>
                                                    <div class="form-group smalls">
                                                        <label>Set max number of answers per question(no more than 10) *</label>
                                                        <input type="number" class="form-control" name="maxAns" required id="maxAns"/>
                                                    </div>
                                                    <div class="form-group smalls">
                                                        <label>Status *</label>
                                                    ...
                                                    <div class="form-group smalls">
                                                        <input type="submit" class="btn theme-bg text-white" value="Add setting" onclick="AddSuccess()">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    function AddSuccess() {
        ...
        var questNumVal = document.getElementById("numberQuest");
        if (maxAns.value < 1 || maxAns.value > 10) {
            alert('Max answers per question must be between 1 and 10');
        }
        if(questNumVal.value > 50){
            alert('Number of question cannot be more than 50');
        }
