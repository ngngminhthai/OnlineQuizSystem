                    ...
                    <div class="col-xl-8 col-lg-8">
                        <div class="blog-wrapper blog-list blog-details blue-blog mb-50">
                            <div class="blog-thumb mb-35">
                                <img src="./BlogDetail_files/news_details_thumb_01.jpg" alt="">
                            ...
                            <div class="blog-content news-content">
                                <div class="blog-meta news-meta">
                                    <span>${requestScope.blog.getLastUpdated()}</span>
                                </div>
                                
                                <h5>${requestScope.blog.getBlogTitle()}</h5>
                                <p>${requestScope.blog.getBlogDetail()}</p>
                                <div class="blog-wrapper-footer" style="margin-top: 44px;">
                                    <!--                                    <div class="news-wrapper-tags">
                                                                            <div class="row">
                                                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                                                    <div class="new-post-tag">
                                                                                        <span>Tags:</span>
                                                                                        <a href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">Business,</a>
                                                                                        <a href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">Finance,</a>
                                                                                        <a href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">Banking,</a>
                                                                                        <a href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">SEO</a>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="col-xl-6 col-lg-6 col-md-6">
                                                                                    <div class="new-post-tag news-share-icon text-left text-md-right">
                                                                                        <span>Share</span>
                                                                                        <a href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">
                                                                                            <i class="fab fa-facebook-f"></i>
                                                                                        </a>
                                                                                        <a class="twitter" href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">
                                                                                            <i class="fab fa-twitter"></i>
                                                                                        </a>
                                                                                        <a class="dribble" href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">
                                        ...
                                        <div class="col-xl-12">
                                            <div class="author-comments-box d-flex">
                                                <div class="author-comments-avatar">
                                                    <img src="${author.getProfilePic()}" alt="">
                                                </div>
                                                <div class="author-comments-text">
                                                    <div class="author-comments-title">
                                                        <h5>${requestScope.author.getFullName()}</h5>
                                                        <span>Author</span>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="latest-comments">
                                                        <ul>
                                                            <li>
                                                                <div class="comments-box main-comments d-flex">
                                                                    <div class="comments-avatar">
                                                                        <img src="./BlogDetail_files/comments_01.png" alt="">
                                                                    </div>
                                                                    <div class="comments-text">
                                                                        ...
                                                                        <a href="https://themepure.net/template/sikkha-prv/sikkha/news_details.html#">Reply</a>
                                                                    </div>
                                                                </div>
                                                                <ul class="comments-reply">
                                                                    <li>
                                                                        <div class="comments-box d-flex">
                                                                            <div class="comments-avatar">
                                                                                <img src="./BlogDetail_files/comments_02.png" alt="">
                                                                            </div>
                                                                            <div class="comments-text">
                                                                                <div class="avatar-name">
                                                                                    <h5>Angelina</h5>
                                                            ...
                                                            <li>
                                                                <div class="comments-box main-comments d-flex">
                                                                    <div class="comments-avatar">
                                                                        <img src="./BlogDetail_files/comments_03.png" alt="">
                                                                    </div>
                                                                    <div class="comments-text">
                                                                        <div class="avatar-name">
                                                                            <h5>Naymer JR</h5>
