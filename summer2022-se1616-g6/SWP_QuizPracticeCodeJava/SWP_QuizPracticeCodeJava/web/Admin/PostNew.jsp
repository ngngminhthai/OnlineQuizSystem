                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8">
                        <form action="postnew" method="post">
                            <div class="blog-wrapper blog-list blog-details blue-blog mb-60">
                                <div class="blog-thumb">
                                    <p class="pt-25 pl-30">Status: 
<!--                                        <label class="switch">
                                            <input type="radio" name="status" value="true">Actice
                                            <input type="radio" name="status" value="false">Deactice
                                    ...
                                    <!--<input class="blog-text-offer text-center blog-cate" name="category" placeholder="Category Name" required>-->
                                ...
                                <div class="blog-content news-content pb-0">
                                    ...
                                    <p>Blog Title</p>
                                    <input class="input-title mb-20" type="text" name="title" required>
                                    <p>Blog Details</p>
                                    <textarea class="input-blogdetail" type="text" name="detail" rows="20" cols="81" required></textarea>
                                    <div class="blog-wrapper-footer" style="margin-top: 44px;"></div>
                                    <p>Blog Brief</p>
                                    <textarea class="input-blogdetail" type="text" name="brief" rows="5" cols="81" required></textarea>
                                </div>
                                    ...
                                    <div class="author-comments-title">
                                        ...
                                        <select name="LUser" id="" class="option" style="font-size: 18px;">
                                            <c:forEach var="listU" items="${requestScope.listUser}">
                                                <option value="${listU.userId}">${listU.fullName}</option>
                                            </c:forEach>            
                                        </select>
                                ...
                                <div class="pt-30 pl-30" id="img-section">
                                    ...
                                    <label for="upload">Upload Photo (Accepted file type .png. Less than 1MB)</label>
                                    <input class="form-control upload_img" type="file" name="file" id="upload" /><br/>
                                </div>
                                <input type="submit" class="btn btn-warning btn-save" value="Create">
                            </div>
                        </form>
                    </div>
