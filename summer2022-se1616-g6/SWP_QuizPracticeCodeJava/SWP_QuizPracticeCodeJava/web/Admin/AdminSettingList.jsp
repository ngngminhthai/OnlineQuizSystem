                            ...
                            <div class="row justify-content-between">
                                <div class="col-lg-12 col-md-12 col-sm-12 pb-4">
                                    <div class="dashboard_wrap d-flex align-items-center justify-content-between">
                                        ...
                                        <div class="elkios">
                                            <a href="addSetting" class="add_new_btn"><i class="fas fa-plus-circle mr-1"></i>Add setting</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="smalls">
                                                                    <select class="form-control" name="type">
                                                                        <option value="0" ${typeChosen == 0 ? "selected" : ""}>All</option>
                                                                        <c:forEach items="${listType}" var="type">
                                                                            <option value="${type.typeid}" ${typeChosen == type.typeid ? "selected" : ""}>${type.getTypeName()}</option>
                                                                        </c:forEach>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="smalls">
                                                                    <select class="form-control" name="status">
                                                                        <option value="2" ${statChosen == 2 ? "selected" : ""}> All</option>
                                                                        <option value="1" ${statChosen == 0 ? "selected" : ""}>Active</option>
                                                                        <option value="0" ${statChosen == 1 ? "selected" : ""}>Deactive</option>  
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="col-xl-12 col-lg-12 col-md-12 mb-2">
                                                <div class="table-responsive">
                                                    <table class="table-striped table" id="datatablesSimple" width="100%" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            <c:forEach items="${listSetting}" var="set">
                                                                <tr>
                                                                    <th>${set.settingID}</th>
                                                                    <td>${set.getSettingTypeName(set.typeID)}</td>
                                                                    <td>${set.settingName}</td>
                                                                    <td>${set.quizDuration}</td>
                                                                    <td>${set.numberOfQuestion}</td>
                                                                    <td>${set.maxNumAnswerPerQuest}</td>
                                                                    <td>${set.status}</td>
                                                                    <td>
                                                                        <div class="dropdown show">
                                                                            ...
                                                                            <div class="drp-select dropdown-menu">
                                                                                <a class="dropdown-item" href="editSetting?sid=${set.settingID}">View&Edit</a>
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                </tr>
