...
<html>
    ...
    <body>
        ...
        <li class="avatar avatar-xl" data-toggle="modal" data-target="#exampleModalCenter" style="justify-content: flex-end;margin-left: 10px">
            <img style="width: 50px;height: 50px" src="${pageContext.request.contextPath}/upload/${user.getProfilePic()}" alt=""/>
        </li>
                    ...
                    <div class="modal-body">
                        <div class="wrapper bg-white mt-sm-5">
                            ...
                            <div class="d-flex align-items-start py-3 border-bottom">
                                <img src="${pageContext.request.contextPath}/upload/${user.getProfilePic()}"
                                     class="img" alt="">
                            ...
                            <div class="py-2">
                                <div class="row py-2">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="bg-light form-control fullName" placeholder="<%=name%>" value="<%=name%>" name="name">
                                    ...
                                    <div class="col-md-6 pt-md-0 pt-3">
                                        ...
                                        <input id="male" <%if (gender) {%>checked=""<%}%> type="radio" name="gender" value="Male" />
                                        <label for="female"  style="">Female</label>

                                        <input id="female" <%if (!gender) {%>checked=""<%}%> type="radio" name="gender" value="Female" />
                                    </div>
                                </div>
                                <div class="row py-2">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6 pt-md-0 pt-3">
                                        ...
                                        <input name="phone" value="<%=phone%>" type="tel" class="bg-light form-control phone" placeholder="<%=phone%>">
                                ...
                                <div class="py-3 pb-4 border-bottom">
                                    <button type="button" class="btn btn-primary mr-3" onclick="sendData()">Save Changes</button>
                                </div>
                                ...
                                <button data-toggle="modal" data-target="#modalChangePassword" type="button" class="btn btn-primary mr-3">Change password</button>
    ...
    <script>
        ...
        var form = document.querySelector(".profileSubmit");
        var name_msg = document.querySelector(".warning_name");
        var phone_msg = document.querySelector(".warning_phone");
