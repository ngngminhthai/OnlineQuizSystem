...
<html>
    ...
    <body>
        ...
        <button data-toggle="modal" data-target="#newPractice" class="btn btn-success">New Practice</button>


        <!-- Modal -->
        <div class="modal fade" id="newPractice" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="QuizPracticeController2" method="get">
                            Subject Name: <select class="form-control" name="subjectid">
                                <c:forEach items="${subjectList}" var="s">
                                    <option value="${s.subjectId}">${s.subjectName}</option>
                                </c:forEach>
                            </select>
                            <br>
                            Number of practice questions: <br> <input name="numberQ" min="1" class="form-control" type="number"> <br>
                            Duration <br>
                            <input class="form-control" min="1" type="number" name="duration"> <br>

                            <button class="btn btn-success">Practice Now</button>
                        </form>
